namespace DZ7
{
    public class AbstractFactory
    {
        ...
        // ConcreteProductA3 - новий продукт для Mercedes
        class Mercedes : Car
        {
            public override void Info()
            {
        ...
        // ConcreteProductB3 - новий продукт для Mercedes
        ...
        // ConcreteFactory3 - нова фабрика для Mercedes
        ...
        static void Main(string[] args)
        {
            ...
            carFactory = new MercedesFactory(); // використовуємо нову фабрику для Mercedes
            myCar = carFactory.CreateCar();
            myCar.Info();
            myEngine = carFactory.CreateEngine();
            myEngine.GetPower();
